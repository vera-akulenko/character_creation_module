...
def attack(char_name, char_class):
    ...
    if char_class == 'healer':
        r = 5 + randint(-3, -1)
        return (f'{char_name} нанёс урон противнику равный {r}')
    return None
...
def special(char_name, char_class):
    if char_class == 'warrior':
        r = 80 + 25
        return (f'{char_name} применил специальное умение «Выносливость {r}»')
    if char_class == 'mage':
        r = 5 + 40
        return (f'{char_name} применил специальное умение «Атака {r}»')
    if char_class == 'healer':
        r = 10 + 30
        return (f'{char_name} применил специальное умение «Защита {r}»')
    return None
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'healer':
            print(
                'Лекарь — могущественный заклинатель. Черпает силы ' +
